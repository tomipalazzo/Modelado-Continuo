...
# ╔═╡ 3d11aaa2-32e3-11ed-2b9d-71d13d7f1756
using DifferentialEquations, OrdinaryDiffEq, Plots

# ╔═╡ 2bef89ef-de3f-4abd-9f0c-2837049687ff
theme(:dracula)

# ╔═╡ e6369071-bce6-47ba-bfc7-a8ba40db3efd
...
# ╔═╡ ce0fc4ae-7cf1-4646-ac00-3f950b71a491
function energy(u1,u2,m)
	0.5m*(u1^2+u2^2)
end

# ╔═╡ 27e1a5e9-152a-468c-aac8-5ae440c40fd9
function  g!(res,u,p,t)
	res[1] = energy(u[1],u[2],p[3])-.5
	res[2] = 0.0
end

# ╔═╡ 3bd79e8b-32c8-466f-9c53-37acbf35db7b
cb = ManifoldProjection(g!)

# ╔═╡ babcb4a5-4729-4d6a-a807-fb48e0c62a55
prob = ODEProblem(oscilador!,[1,0],(0.0,1000.0),[1,0,1])

# ╔═╡ 9227a52c-dc64-41cb-8d03-ac278e5ef248
sol = solve(prob,Vern7(),callback=cb)

# ╔═╡ c970af3c-eaf4-4b5b-9713-36f77170a418
plot(sol,idxs=1)

# ╔═╡ 7fbe10f4-d1f0-4ad9-8231-244b6e259de3
plot(sol,idxs=((t,a,b)->(t,energy(a,b,1)),0,1,2),ylims =(0.49,0.51))

# ╔═╡ 4600358c-647c-4ab6-a1a6-233b0c299730
begin 
	sol₀ = solve(prob,Vern7())
	plot(sol₀,idxs=((t,a,b)->(t,energy(a,b,1)),0,1,2),ylims=(0.49,0.51))
end

# ╔═╡ a9dfdcdd-9a34-4c04-a7b5-042148ad45ac
plot(sol₀,idxs=1)

# ╔═╡ 82c14421-1cbc-4a24-a8ef-e07d0db6dc5b
