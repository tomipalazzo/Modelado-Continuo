...
# ╔═╡ 4d07049e-32ae-11ed-2bdd-67dff8a4b701
begin 
...
# ╔═╡ 861a2ba3-cb92-452f-8cf6-fd5411ec309e
md"""
# Ejercicio 18
"""

# ╔═╡ e986ec10-e204-42bf-81ac-b3c880df9776


# ╔═╡ ac5e69bd-9445-406c-b397-6ccb9e04d977
function OAA!(du, u, p, t)
	m,k,b,forzante = p
	
	du[1] = u[2]
	du[2] = (forzante(t, u[1]) - b*u[2] - k*u[1]) / m
end

# ╔═╡ da968eae-e8c5-46ed-bdcb-623df1ee170d
function res_18(p, t_final,u₀)
	t  = (0.0,t_final) 
	P  = ODEProblem(OAA!,u₀,t,p)
	solve(P, abstol=1e-10,reltol=1e-10)
end

# ╔═╡ a5c8fe11-caa6-495a-8394-0e6e5de74dcb
begin
	# Constantes
...
# ╔═╡ cafe21e3-1960-4a8c-9670-2b84385675fa
begin
...
# ╔═╡ d2357711-39ce-4123-9c77-4b75128092ec
begin
	forzante(t,x) = 0 
	s_18 = res_18([m,k,b,forzante], t_fi, [-10,10])
end

# ╔═╡ 96b93e3e-a16c-4787-a244-c03338dfebb4
plot(s_18, label=["Posicion" "Velocidad"])

# ╔═╡ 69927b30-4e42-4092-9b36-7a7ff2bd2155
energia(t,a,b) = (t, 1/2 * k*a^2 + 1/2 * m*b^2)

# ╔═╡ 5b74fd3f-7a82-4842-877a-65c4e0c7fdb7
plot(s_18, idxs=(energia,0,1,2), ylim= (50, 150))

# ╔═╡ a44d41e2-3c8a-4d87-85ea-4eddaf6291ee
...
# ╠═5b74fd3f-7a82-4842-877a-65c4e0c7fdb7
# ╠═a44d41e2-3c8a-4d87-85ea-4eddaf6291ee
# ╠═f4b00673-e02a-4ab6-92b4-0563c8b18b00
# ╟─00000000-0000-0000-0000-000000000001
# ╟─00000000-0000-0000-0000-000000000002
